...
class InfluencerContentView extends StatefulWidget {
  final Video? video;

  const InfluencerContentView({Key? key, required this.video})
      : super(key: key);

  @override
  State<InfluencerContentView> createState() => _InfluencerContentViewState();
}

class _InfluencerContentViewState extends State<InfluencerContentView> {
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  InfluencerVideoDescription(video: widget.video),
                  SizedBox(
                    width: 80.0,
